...
```{r}
n <- 20
f2 <- function(silhouette, p) {
  return(cov(silhouette, 1 / p))
}

g2 <- function(silhouette, p) {
  return(sd(silhouette) * sd(1 / p))
}

rho <- function(silhouette, p) {
  return(corr(silhouette, 1 / p))
}
...
dg2_dS <- function(silhouette, p) {
  return(sd(1 / p) * (silhouette - mean(silhouette)) / n / sd(silhouette))
}

df2_dalpha <- function(p) {
